...
def plot(data, main="", xlab="", ylab=""):
	...
	if isinstance(data, 
		...
		raise ValueError(' '.join(['data has to be elements of', \
					'FDApy.univariate_functional.UnivariateFunctionalData', \
					'or FDApy.irregular_functional.IrregularFunctionalData', \
					'or FDApy.multivariate_functional.MultivariateFunctionalData!']))
