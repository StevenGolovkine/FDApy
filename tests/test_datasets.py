...
from FDApy.simulation.datasets import _zhang_chen, Datasets
...
class ZhangChangTestCase(unittest.TestCase):
    ...
    def test_zhang_chang_cos_sin(self):
        ...
        expected_results = np.array(
            [
                [2.63139013, 5.02482289, 6.60973235, 5.8997611, 2.48634443, -1.16218953, -4.02114032, -3.39676508, -1.05722496, 2.36348728],
                [5.4050085, 6.01901495, 5.81901528, 3.17679982, 0.40184728, -1.65134235, -1.00260541, 0.10582, 2.66644022, 5.13092035],
            ]
        )
