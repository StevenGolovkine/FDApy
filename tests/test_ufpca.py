...
class TestFitInnerProduct(unittest.TestCase):
    ...
    def test_fit_inner_product_dense(self):
        ...
        ufpca = UFPCA(n_components=3)
        ufpca._fit_inner_product(data=self.fdata_uni, points=points, mean=mean)

        # expected_eigenvalues = np.array([0.24674571, 0.11342926, 0.05243551])
        # np.testing.assert_array_almost_equal(ufpca.eigenvalues, expected_eigenvalues)

        # expected_eigenfunctions = np.array([[ 0.07904154, -0.05222265, -0.17323265, -0.28448736,  -0.3868238 , -0.48102086, -0.5678108 , -0.64795088,  -0.72207159, -0.79081814, -0.85474405, -0.91441103,  -0.97069414, -1.02065543, -1.06304923, -1.09810415,  -1.12595128, -1.1463941 , -1.15914586, -1.16545192,  -1.16833288, -1.16685619, -1.16041269, -1.14840723,  -1.13015456, -1.10498949, -1.0721195 , -1.03078058,  -0.98016107, -0.9193888 , -0.84794346], [ 1.88208228,  1.79577344,  1.70516486,  1.61038688,   1.51171683,  1.40940611,  1.30369798,  1.19489927,   1.08334643,  0.96948971,  0.85384881,  0.73706397,   0.61993712,  0.50173883,  0.38267517,  0.26362454,   0.14563359,  0.02984783, -0.08266389, -0.19209738,  -0.30049162, -0.40672232, -0.50984083, -0.60897182,  -0.7032243 , -0.79177257, -0.87374167, -0.94831202,  -1.01463633, -1.07181493, -1.11926141], [ 1.67845114,  1.44501386,  1.22091939,  1.00733161,   0.80499758,  0.61475463,  0.43754642,  0.27418068,   0.1256016 , -0.00760612, -0.12493994, -0.22619307,  -0.3127769 , -0.37900483, -0.42028517, -0.43499739,  -0.42147436, -0.37760661, -0.30166002, -0.1982086 ,  -0.07770829,  0.06457073,  0.23115895,  0.4239572 ,   0.64469137,  0.89441943,  1.17436958,  1.48542917,   1.82865369,  2.20532378,  2.61551035]])
        # np.testing.assert_array_almost_equal(np.abs(ufpca.eigenfunctions.values), np.abs(expected_eigenfunctions))

        # expected_covariance = np.array([ 0.50952527,  0.47594862,  0.44207192,  0.40801633,  0.37390572,  0.3398648 ,  0.30602404,  0.27251691,  0.23949161,  0.20709245,  0.17547053,  0.14477914,  0.11508598,  0.08663548,  0.05980147,  0.03488863,  0.01223814, -0.00775936, -0.02475845, -0.03912953, -0.05204127, -0.06291829, -0.07138346, -0.07712214, -0.0798309 , -0.07926995, -0.07517822, -0.06733138, -0.05548732, -0.039377  , -0.0188823 ])
        # np.testing.assert_almost_equal(ufpca._covariance.values[0, 1], expected_covariance)
