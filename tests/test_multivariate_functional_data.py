...
class TestNormMultivariateFunctionalData(unittest.TestCase):
    ...
    def test_norm(self):
        res = self.fdata.norm()
        expected_res = np.array([1.05258869, 0.3708455 , 1.11546354, 0.5636047 , 0.90327287, 0.75064308, 0.94101483, 1.33889354, 0.65137428, 0.9804458 ])
...
class TestInnerProductMultivariateFunctionalData(unittest.TestCase):
    ...
    def test_inner_prod(self):
        ...
        expected_res = np.array([
            [0.47349529, -0.13685186,  0.19119084, -0.03992746,  0.33384288,
             0.11100958, -0.34205956, -0.47111704, -0.26865753,  0.1448863],
            [-0.13685186,  0.12450628, -0.22608606,  0.05969545, -0.09813655,
                -0.13059145,  0.23567236,  0.31842272,  0.06843584, -0.18454769],
            [0.19119084, -0.22608606,  0.48887238, -0.16196905,  0.17461587,
                0.28840398, -0.47155034, -0.65736206, -0.10689362,  0.40955172],
            [-0.03992746,  0.05969545, -0.16196905,  0.17612865, -0.15066836,
                -0.14634096,  0.20094949,  0.27361664,  0.09435212, -0.18174139],
            [0.33384288, -0.09813655,  0.17461587, -0.15066836,  0.35205208,
                0.15040087, -0.3301055, -0.45477844, -0.27455165,  0.17201809],
            [0.11100958, -0.13059145,  0.28840398, -0.14634096,  0.15040087,
                0.20536565, -0.30116113, -0.41335325, -0.09709361,  0.25418339],
            [-0.34205956,  0.23567236, -0.47155034,  0.20094949, -0.3301055,
                -0.30116113,  0.55853624,  0.75736446,  0.24419536, -0.40056556],
            [-0.47111704,  0.31842272, -0.65736206,  0.27361664, -0.45477844,
                -0.41335325,  0.75736446,  1.05971458,  0.32831889, -0.56709246],
            [-0.26865753,  0.06843584, -0.10689362,  0.09435212, -0.27455165,
                -0.09709361,  0.24419536,  0.32831889,  0.2357352, -0.09771088],
            [0.1448863, -0.18454769,  0.40955172, -0.18174139,  0.17201809,
                0.25418339, -0.40056556, -0.56709246, -0.09771088,  0.37342934]
        ])
        np.testing.assert_array_almost_equal(res, expected_res)
    ...
    def test_inner_prod_with_unknow_variance(self):
        ...
        expected_res = np.array([
            [0.42827499, -0.13685186,  0.19119084, -0.03992746,  0.33384288,
             0.11100958, -0.34205956, -0.47111704, -0.26865753,  0.1448863],
            [-0.13685186,  0.07928598, -0.22608606,  0.05969545, -0.09813655,
                -0.13059145,  0.23567236,  0.31842272,  0.06843584, -0.18454769],
            [0.19119084, -0.22608606,  0.44365208, -0.16196905,  0.17461587,
                0.28840398, -0.47155034, -0.65736206, -0.10689362,  0.40955172],
            [-0.03992746,  0.05969545, -0.16196905,  0.13090835, -0.15066836,
                -0.14634096,  0.20094949,  0.27361664,  0.09435212, -0.18174139],
            [0.33384288, -0.09813655,  0.17461587, -0.15066836,  0.30683178,
                0.15040087, -0.3301055, -0.45477844, -0.27455165,  0.17201809],
            [0.11100958, -0.13059145,  0.28840398, -0.14634096,  0.15040087,
                0.16014534, -0.30116113, -0.41335325, -0.09709361,  0.25418339],
            [-0.34205956,  0.23567236, -0.47155034,  0.20094949, -0.3301055,
                -0.30116113,  0.51331594,  0.75736446,  0.24419536, -0.40056556],
            [-0.47111704,  0.31842272, -0.65736206,  0.27361664, -0.45477844,
                -0.41335325,  0.75736446,  1.01449428,  0.32831889, -0.56709246],
            [-0.26865753,  0.06843584, -0.10689362,  0.09435212, -0.27455165,
                -0.09709361,  0.24419536,  0.32831889,  0.1905149, -0.09771088],
            [0.1448863, -0.18454769,  0.40955172, -0.18174139,  0.17201809,
                0.25418339, -0.40056556, -0.56709246, -0.09771088,  0.32820903]
        ])
        np.testing.assert_array_almost_equal(res, expected_res)
...
class TestCovarianceMultivariateFunctionalData(unittest.TestCase):
    ...
    def test_covariance(self):
        ...
        expected_values = np.array([0.16515663, 0.1462883 , 0.11637048, 0.08890965, 0.07124684, 0.05672914, 0.0534345 , 0.05765955, 0.06480845, 0.07809725, 0.09294409])
...
class TestConcatenateMultivariateFunctionalData(unittest.TestCase):
    ...
    def test_concatenate_error(self):
        new = MultivariateFunctionalData([self.fdata_uni, self.fdata_sparse, self.fdata_uni])
        with self.assertRaises(ValueError):
