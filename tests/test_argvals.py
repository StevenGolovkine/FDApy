...
class TestDenseArgvals(unittest.TestCase):
    ...
    def test_normalization(self):
        argvals = {
            "input_dim_0": np.arange(0, 51, 1),
            "input_dim_1": np.arange(0, 21, 1),
        }
        argvals = DenseArgvals(argvals)

        expected_output = DenseArgvals(
            {
                "input_dim_0": np.array(
                    [
                        0.0,
                        0.02,
                        0.04,
    ...
    def test_concatenate(self):
        ...
        argvals_2 = {
            "input_dim_0": np.arange(0, 21, 1),
            "input_dim_1": np.arange(0, 51, 1),
        }
...
class TestIrregularArgvals(unittest.TestCase):
    ...
    def test_min_max(self):
        argvals_1 = DenseArgvals(
            {"input_dim_0": np.array([1, 2]), "input_dim_1": np.array([5, 8, 9])}
        )
        argvals_2 = DenseArgvals(
            {"input_dim_0": np.array([6, 8]), "input_dim_1": np.array([4, 7])}
        )
        argvals_irr = IrregularArgvals({0: argvals_1, 1: argvals_2})
        ...
        expected_output = IrregularArgvals(
            {
                ...
                1: DenseArgvals(
                    {
                        "input_dim_0": np.array([0.0, 0.25, 0.5, 0.75, 1.0]),
                        "input_dim_1": np.array(
                            [
                                0.0,
                                0.16666667,
    ...
    def test_to_dense(self):
        argvals_1 = DenseArgvals(
            {"input_dim_0": np.array([1, 2, 3]), "input_dim_1": np.array([4, 5, 6])}
        )
        argvals_2 = DenseArgvals(
            {"input_dim_0": np.array([2, 4, 6]), "input_dim_1": np.array([1, 3, 5])}
        )
        argvals = IrregularArgvals({0: argvals_1, 1: argvals_2})
